...
echo "<table border='1' vertical-align='middle' bgcolor='#ffffcc'>";
...
for($tr=1;$tr<=$rows;$tr++){
    ...
    echo "<tr >";
		...
		//$_SESSION['dice']= $_SESSION['dice']." ,".$players[ 0][ "name" ]." score was reduced by 5 positions since your score was ".$count;
            $_SESSION['dice']= $_SESSION['dice']." ,Danger zone - ".$players[ 0][ "name" ]." score reduced by 5 positions";//.$count;
			} 
		...
		//$_SESSION['dice']=$_SESSION['dice']." ,".$players[ 1][ "name" ]." score was reduced by 5 positions since your score was ".$count;
            $_SESSION['dice']=$_SESSION['dice']." ,Danger zone - ".$players[ 1][ "name" ]." score reduced by 5 positions";//.$count;
			}
			}
			 else
			 {
		   ...
		   else  if($count==$_SESSION['players'][ 0 ][ "score" ])
		   {
			...
			{ $_SESSION['dice']=$_SESSION['dice']." ,".$_SESSION['players'][ 0 ][ "name" ]."  Won";
                //$_SESSION['winner'] = $_SESSION['players'][ 0 ][ "name" ];
		   ...
		   { 
			...
			{ $_SESSION['dice']=$_SESSION['dice']." ,".$_SESSION['players'][ 1 ][ "name" ]."  Won";
                //$_SESSION['winner'] = $_SESSION['players'][ 1 ][ "name" ];
            //    header("Location: gamewon.php");
            //    exit();
            }
